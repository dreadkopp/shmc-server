...
var documentsMain = {
	...
	UI : {
		...
		showViewer: function(fileId, title){
			...
			var frame = '<iframe sandbox="allow-scripts allow-same-origin allow-popups allow-modals" id="loleafletframe_viewer" name= "loleafletframe_viewer" style="width:100%;height:100%;position:absolute;"/>';
