...
var odfViewer = {
	...
	onEdit : function(fileName, context) {
		...
		var $iframe = $('<iframe id="richdocumentsframe" sandbox="allow-scripts allow-forms allow-same-origin allow-popups allow-modals" style="width:100%;height:100%;display:block;position:absolute;top:0;" src="'+viewer+'" />');
		if ($('#isPublic').val()) {
